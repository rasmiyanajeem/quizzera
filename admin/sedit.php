            ...
            <div class="card hoverable" id="edit">
				...
				if(isset($_POST['submit']))
	  			{
	   				...
	   				$state=$_POST['state'];
	   				$dob=$_POST['dob'];
	  			    $query="UPDATE `student_details` SET `sfname`='$fname',`slname`='$lname',`course`='$course',`email`='$email',`phone`='$phone',`gender`='$gender',`state`='$state',`country`='$country',`dob`='$dob' WHERE sid='$id'";
					echo $query;
                ...
                <form class="col s12" method="post">
                            ...
                            <div class="input-field col s12">
                                <input id="first_name" type="text" name="f_name"  value="<?php echo $row['sfname']?>">
                                <label for="first_name">First Name</label>
                            </div>
                            
                            <div class="input-field col s12">
                                <input id="last_name" type="text" name="l_name" value="<?php echo $row['slname']?>" >
                                <label for="last_name">Last Name</label>
                            </div>
                            <div class="input-field col s12">
                                <input id="regno" type="text" name="username" value="<?php echo $row['sid']?>">
                           ...
                           <div class="input-field col s12">
                                <input id="course" type="text" name="course" value="<?php echo $row['course']?>">
