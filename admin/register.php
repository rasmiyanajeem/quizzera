	  ...
	  if(isset($_POST['submit']))
	  {
	   ...
	   $query = mysqli_query($con,"SELECT username from reg_users where username='$username'");
		...
		else
		{
				...
				{ 
					$query1="INSERT INTO admin_details(aid, fname, lname, email,phone, gender, dob, state, country) VALUES	('$username','$fname','$lname','$email','$phone','$gender','$dob','$state','$country')";
					

					mysqli_query($con,$query1) or die(mysqli_error($con));
  					$query2="INSERT INTO reg_users(`aid`, `username`, `password`, `designation`) VALUES('$username','$username','$password1','$designation')";
                        ...
                        <form class="col s12"  action="register.php" method="post">
                           ...
                           <option value=" Nagaland">  Nagaland </option> 
                            ...
                            <label for="country" style="font-size:16px"> Country</label>
                             ...
                             <div class="col s12">
							<select class="browser-default" name="country" disabled>
