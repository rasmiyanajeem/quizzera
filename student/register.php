 ...
 include('../config.php');
	  ...
	  if(isset($_POST['submit']))
	  {
	   ...
	   $query = mysqli_query($con,"SELECT username from reg_users where username='$username'");
		...
		{
 				 echo "<script>alert('Register number already exit!')</script>";
		}
		else
		{
				...
				{ 
					$query1="INSERT INTO `student_details`(`sid`, `sfname`, `slname`, `course`, `gender`, `state`, `country`, `dob`, `email`, `phone`) VALUES ('$username','$fname','$lname','$course','$gender','$state','$country','$dob','$email','$phone')";
					echo $query1;

					mysqli_query($con,$query1) or die(mysqli_error($con));
  					$query2="INSERT INTO reg_users(`sid`, `username`, `password`, `designation`) VALUES('$username','$username','$password1','$designation')";
        ...
        <div class="col s12 m6 offset-m3" style="margin-top: 5%">
            <div class="card hoverable" id="register">
                <div class="card-content">
                    <span class="card-title center-align">Student Registration</span>
                    ...
                    <div class="row">
                       <form class="col s12"  action="register.php" method="post">
                            ...
                            <div class="col s12">
							<select class="browser-default" name="designation" >
                           ...
                           <div class="input-field col s12">
                                ...
                                <label for="course">Course(in caps ,eg: INT MCA 2015, B.COM 2015 )</label>
                            </div>
                            <div class="input-field col s12">
